...
/**
 * Changes between format strings.
 */
public interface CommonFormatStringRewriter {

	/**
	 * Replaces "{}" with "%s". Keeps special strings like "\\{}" intact.
	 *
	 * @param log4JString The string with {} as placeholder.
	 * @return The same string with %s as placeholder.
	 */
	String fromLog4JToNormalString(String log4JString);
}
